...
pub struct Config {
    ...
    pub fee: u16,                  // Total swap fee in basis points (applied by the curve)
    pub protocol_fee: u16,         // Share of collected fee sent to treasury (bps of fee, 0..=10_000)
    pub treasury: Pubkey,          // Wallet that owns the treasury token accounts
